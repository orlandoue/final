...
import 'package:orland_sports/View/Screens/Store/Payments/AddMethod.dart';
...
class Store_PaymentMethod extends StatefulWidget {
  const Store_PaymentMethod({super.key});

  @override
  State<Store_PaymentMethod> createState() => _Store_PaymentMethodState();
}

class _Store_PaymentMethodState extends State<Store_PaymentMethod> {
  @override
