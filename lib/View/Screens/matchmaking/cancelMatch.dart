...
import 'package:orland_sports/View/Widgets/BottomSheets.dart';
...
class CancelMatch extends StatefulWidget {
  const CancelMatch({super.key});

  @override
  State<CancelMatch> createState() => _CancelMatchState();
}
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                MyButton(
                  onTap: () {
                   Get.bottomSheet(CancelMatchBottomSheet(),isScrollControlled: true);
                  },
                  buttonText: cancelMatch,
                  mBottom: 40,
                ),
              ],
            ),
